...
| <a name="input_enable_tag_defaults"></a> [enable\_tag\_defaults](#input\_enable\_tag\_defaults) | Whether this module instance manages tag defaults. | `bool` | `true` | no |
...
| <a name="output_tag_defaults_configuration"></a> [tag\_defaults\_configuration](#output\_tag\_defaults\_configuration) | The normalized tag-default configuration keyed by stable logical identifiers. |
<!-- END_TF_DOCS -->