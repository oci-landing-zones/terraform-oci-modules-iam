# OCI Landing Zones IAM Policy Module
...
```
module "policies" {
  source = "github.com/oci-landing-zones/terraform-oci-landing-zone-iam/policies"
  tenancy_ocid = var.tenancy_ocid
  policies_configuration = var.policies_configuration
}
```
...
```
  source = "github.com/oci-landing-zones/terraform-oci-landing-zone-iam//policies?ref=v0.1.0"
```
