...
locals {  
  ...
  object_storage_regions = var.policies_configuration.template_policies != null ? (var.policies_configuration.template_policies.tenancy_level_settings != null ? (var.policies_configuration.template_policies.tenancy_level_settings.oci_services != null ? (coalesce(var.policies_configuration.template_policies.tenancy_level_settings.oci_services.enable_object_storage_policies,[1]) != [1] ? var.policies_configuration.template_policies.tenancy_level_settings.oci_services.enable_object_storage_policies : null) : null) : null) : null
