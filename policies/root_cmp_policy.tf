...
locals {
  ...
  group_names = trim(join(",", keys(local.group_name_to_role_map)),",") # this produces a comma separated string of group names, like "group-name-1, group-name-2, group-name-3"
